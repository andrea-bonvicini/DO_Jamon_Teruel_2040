...
export function WelcomeScreen() {
  ...
  return (
    ...
    >
      {/* The real marks. They live here, on cream, because the Teruel ones are
          red and pink on transparent and would vanish on the band.
          The three sit at equal weight at the project owner's request. */}
      <div className="cover">
        <img
